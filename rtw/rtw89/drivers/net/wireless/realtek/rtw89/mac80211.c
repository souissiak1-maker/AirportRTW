...
/* Senmiko.c — releases the kext-managed chanctx before vif teardown. */
				       ...
				       struct ieee80211_vif *vif)
{
	...
	/* The Senmiko kext never calls unassign_vif_chanctx — release the
	 * connect-flow chanctx (Senmiko.c) so the vif is off the mgnt
