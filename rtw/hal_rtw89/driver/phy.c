				    ...
				    bool p2p, bool csi)
{
	...
	ra->ldpc_cap = ldpc_en;
#ifdef RTW89_MACOS
	/* 0.2.43: capture the exact operands that feed ss_num. */
	rtw89_macos_ra_audit_u32(41, link_sta->rx_nss);
	rtw89_macos_ra_audit_u32(42, rtwdev->hal.tx_nss);
#endif
...
#ifdef RTW89_MACOS
	rtw89_macos_assoc_stage_probe(1);
#endif
...
#ifdef RTW89_MACOS
	/* 0.2.42: passive association RA snapshot. */
	rtw89_macos_ra_audit_u32(0, ra->macid);
	rtw89_macos_ra_audit_u32(1, ra->mode_ctrl);
	rtw89_macos_ra_audit_u32(2, ra->bw_cap);
	rtw89_macos_ra_audit_u32(3, ra->ss_num);
	rtw89_macos_ra_audit_u32(4, ra->init_rate_lv);
	rtw89_macos_ra_audit_u32(5, ra->upd_all);
	rtw89_macos_ra_audit_u32(6, ra->dcm_cap);
	rtw89_macos_ra_audit_u32(7, ra->er_cap);
	rtw89_macos_ra_audit_u32(8, ra->en_sgi);
	rtw89_macos_ra_audit_u32(9, ra->ldpc_cap);
	rtw89_macos_ra_audit_u32(10, ra->stbc_cap);
	rtw89_macos_ra_audit_u32(11, ra->giltf);
	rtw89_macos_ra_audit_u32(12, ra->upd_bw_nss_mask);
	rtw89_macos_ra_audit_u32(13, ra->upd_mask);
	rtw89_macos_ra_audit_u32(14, ra->band_num);
	rtw89_macos_ra_audit_u32(15, ra->ra_csi_rate_en);
	rtw89_macos_ra_audit_u32(16, ra->fixed_csi_rate_en);
	rtw89_macos_ra_audit_u32(17, ra->cr_tbl_sel);
	rtw89_macos_ra_audit_u32(18, ra->fix_giltf_en);
	rtw89_macos_ra_audit_u32(19, ra->fix_giltf);
	rtw89_macos_ra_audit_u32(20, ra->partial_bw_er);
	rtw89_macos_ra_audit_u32(21, ra->csi_mcs_ss_idx);
	rtw89_macos_ra_audit_u32(22, ra->csi_mode);
	rtw89_macos_ra_audit_u32(23, ra->csi_gi_ltf);
	rtw89_macos_ra_audit_u32(24, ra->csi_bw);
	rtw89_macos_ra_audit_u32(25, ra->is_noisy);
	rtw89_macos_ra_audit_u32(26, ra->psra_en);
	rtw89_macos_ra_audit_u32(27, ra->macid_msb);
	rtw89_macos_ra_audit_u32(28, ra->band);
	rtw89_macos_ra_audit_u32(29, ra->is_new_dbgreg);
	rtw89_macos_ra_audit_u32(30, csi ? 1U : 0U);
	rtw89_macos_ra_audit_u32(31, rssi);
	rtw89_macos_ra_audit_u64(0, (unsigned long long)ra->ra_mask);
#endif

#ifdef RTW89_MACOS
	rtw89_macos_assoc_stage_probe(2);
#endif
...
#ifdef RTW89_MACOS
	/* Passive snapshot of the firmware-selected live transmit rate. */
	rtw89_macos_ra_audit_u32(43, mode);
	rtw89_macos_ra_audit_u32(44, ra_report->txrate.mcs);
	rtw89_macos_ra_audit_u32(45, ra_report->txrate.bw);
	rtw89_macos_ra_audit_u32(46, ra_report->txrate.nss);
	rtw89_macos_ra_audit_u32(47, ra_report->txrate.flags);
	rtw89_macos_ra_audit_u32(48, ra_report->bit_rate);
	rtw89_macos_ra_audit_u32(49, ra_report->hw_rate);
#endif
}
...
bool rtw89_phy_c2h_chk_atomic(struct rtw89_dev *rtwdev, u8 class_id, u8 func)
{
	switch (class_id) {
