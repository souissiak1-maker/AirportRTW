...
/* ------------------------------------------------------------------ */
/*  zlib allocators — mirrors rtw/rtw80211/zutil.c exactly          */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/*  Decompress one blob — mirrors AirportRTW's uncompressFirmware()        */
/* ------------------------------------------------------------------ */
...
static struct firmware *load_fw_from_blob(const char *base)
{
    for (int i = 0; rtw88_fw_blobs[i].name; i++) {
        ...
        /* 4× compressed size — same generous bound as AirportRTW */
