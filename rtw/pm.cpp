...
IOReturn RTWCore::setPowerState(unsigned long powerStateOrdinal, IOService *policyMaker)
{
...
IOReturn RTWCore::setWakeOnMagicPacket(bool active)
{
...
IOReturn RTWCore::registerWithPolicyMaker(IOService *policyMaker)
{
    IOReturn ret;
