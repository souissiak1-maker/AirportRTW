...
#ifndef AirportRTWV2_hpp
#define AirportRTWV2_hpp
...
class AirportRTW : public IO80211Controller {
    OSDeclareDefaultStructors(AirportRTW)
...
public:
    ...
    AirportRTWEthernetInterface *bsdInterface;
